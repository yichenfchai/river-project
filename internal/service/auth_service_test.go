...
type mockUserRepo struct {
	...
	updatePassword   func(ctx context.Context, id, password string) error
}
...
func (m *mockUserRepo) UpdatePassword(ctx context.Context, id, password string) error {
	if m.updatePassword != nil {
		return m.updatePassword(ctx, id, password)
	}
	return nil
}
func (m *mockUserRepo) Seed(ctx context.Context) error { return nil }
