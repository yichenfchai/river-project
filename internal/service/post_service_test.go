...
type mockPostRepo struct {
	...
	findCommentByIDFn func(ctx context.Context, id string) (*model.Comment, error)
...
func (m *mockPostRepo) FindCommentByID(ctx context.Context, id string) (*model.Comment, error) {
	if m.findCommentByIDFn != nil {
		return m.findCommentByIDFn(ctx, id)
	}
...
func (m *mockPostRepo) Seed(ctx context.Context) error { return nil }
